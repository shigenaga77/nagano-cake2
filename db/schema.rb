...
ActiveRecord::Schema.define(version: 2023_02_19_153156) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.string "postal_code", null: falsea
  ...
  create_table "genre_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_genre_items_on_email", unique: true
    t.index ["genre_id"], name: "index_genre_items_on_genre_id"
    t.index ["item_id"], name: "index_genre_items_on_item_id"
    t.index ["reset_password_token"], name: "index_genre_items_on_reset_password_token", unique: true
  end
